...
def show_banner():
    text = Text()
    text.append("🎯 ALTERNANCE TRACKER\n", style="bold cyan")
...
@app.command("lettre", help="✍️  Générer une lettre de motivation")
def generer_lettre(
...
@app.command("setup", help="⚙️  Configurer le projet (première utilisation)")
def setup():
